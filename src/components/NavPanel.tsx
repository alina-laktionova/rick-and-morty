...
const rickAndMortyLogo = 'https://res.cloudinary.com/imagenbcsdr/image/upload/v1653593234/rick-and-morty/rick-and-morty_h6jcug.png'
            ...
            <Toolbar disableGutters
                ...
                <Box>
                    <Tabs value={location.pathname}>
                        <Tab label={smScreen && "Characters"} icon={<AccountBoxIcon/>} iconPosition="start"
                             value={CHARACTERS} component={Link} to={CHARACTERS}/>
                        <Tab label={smScreen && "My watch list"} icon={<CheckBoxIcon/>} iconPosition="start"
                             value={WATCH_LIST} component={Link} to={WATCH_LIST}/>
                    </Tabs>
                </Box>
            </Toolbar>
        </Container>
